...
public class SeleniumAffecterTache {
	...
	@Test
	public void testSeleniumAffecterTache() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.type("name=debut", "0");
		selenium.type("name=duree", "5");
		selenium.click("//input[@value='Affecter']");
		selenium.waitForPageToLoad("30000");
	}
