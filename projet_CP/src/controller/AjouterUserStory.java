...
public class AjouterUserStory extends HttpServlet {
	...
	{
		this.getServletContext().getRequestDispatcher(VUE_AJOUTER_USER_STORY).forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		UserStory userStory = new UserStory(description, difficulte, priorite, idProjet);
		...
		//this.getServletContext().getRequestDispatcher(VUE_PROJET+"?idProjet="+idProjet).forward(request, response);
	}
