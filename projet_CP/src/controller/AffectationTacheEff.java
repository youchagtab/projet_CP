...
/**
 * Servlet implementation class AffectationTacheEff
 */
@WebServlet("/AffectationTacheEff")
public class AffectationTacheEff extends HttpServlet {
	...
	{
		System.out.println("Efffffectif");
		IGanttEffectifDAO ganttDAO = new GanttEffectifDAOImpl();
